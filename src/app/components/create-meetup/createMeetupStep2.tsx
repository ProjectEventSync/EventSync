...
// Date, time, location
export default function CreateMeetupStep2({date, time, location, setDate, setTime, setLocation, changeStep} : {date: string, time: string, location: string, setDate: (date: string) => void, setTime: (time: string) => void, setLocation: (location: string) => void, changeStep: () => void}) {{}
    return (
        <div className=" flex justify-center items-center h-full w-full">
            <div className="flex flex-col rounded-md w-auto h-auto p-4">
                ...
                <Input placeholder={date || "Date"} className="w-full" onValueChange={setDate}/>
